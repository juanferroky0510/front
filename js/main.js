...
function getAllCities() {
  ...
  axios.get('//54.159.232.242/php-intro-connection/front-end/php/connect.php?action=getAll')
...
function getOneCity() {
  ...
  if (idCiudad) {
    axios.get(`//54.159.232.242/php-intro-connection/front-end/php/connect.php?action=getOne&id=${idCiudad}`)
      .then(function (response) {
